            ...
            <div class="row g-4">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary card-outline mb-4">
                  ...
                  <!--end::Header-->
                  <!--begin::Form-->
                  <form action="{{url('/manage/category-update/'.$category->id)}}" method="Post" enctype="multipart/form-data" required>
                    @csrf
                    <!--begin::Body-->
                    <div class="card-body">
                      <div class="mb-3">
                        ...
                        <input
                          type="text"
                          class="form-control" value="{{$category->name}}" name="name" id="name" required />
                           </div>
